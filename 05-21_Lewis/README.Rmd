...
quarter <- "Spring2020"
date <- "05/21"
week_folder <- "05-21_Lewis"


title <- "Gender Stereotypes Reflected in the Distributional Structure of 25 Languages
"


speaker <- "Molly Lewis"
department <- "Research Scientist in the Psychology and Social and Decision Sciences Departments"
university <- "Carnegie Mellon University"
github_home <- "https://github.com/uchicago-computation-workshop"

#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Spring2020/issues/5"
zoom_url <- "https://uchicago.zoom.us/meeting/register/tJMkdeuorz0pGdZm2Wueawx0P9qScNKwKC9g"
